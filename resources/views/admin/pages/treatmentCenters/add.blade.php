...
<div class="card">
    <div class="card-body">
        <h2 class="mb-5">اضافة مركز</h2>
        <form class="forms-sample" action="{{ route('treatmentCenters_save') }}" method="post">
            @csrf
            ...
            <div class="form-group">
                ...
                <input required type="text" class="form-control" id="exampleInputUsername1" name="phone" placeholder="الهاتف">
            </div>
            <div class="form-group">
