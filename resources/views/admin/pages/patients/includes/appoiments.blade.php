<div class="card">
    <div class="card-body">
        ...
        <div class="card-title">
            ...
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal-4" data-whatever="@mdo">اضافة</button>
            <div class="modal fade" id="exampleModal-4" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg " role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('patients_app_save') }}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="recipient-name" class="col-form-label">تاريخ:</label>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('section_delete',$d->id) }}" class="btn btn-danger">حذف</a>
                                </td>
                            </tr>
                            @endforeach
