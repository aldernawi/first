...
<div class="card">
    <div class="card-body">
        <h2 class="mb-5">اضافة بيانات مريض</h2>

        <form class="forms-sample" action="{{ route('patients_save') }}" method="post">
            @csrf
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control" id="exampleInputPassword1" name="dig" placeholder="حالة المريض">
